...
**** Org-roam
Org roam is by /org-research/ which helps in developing a knowledge management system based off of [[https://zettelkasten.de/overview/][zettelkasten system]]
/System crafters/ has created a neat document to work with org-roam [[https://systemcrafters.net/build-a-second-brain-in-emacs/getting-started-with-org-roam/][here]]
#+begin_src emacs-lisp
  (use-package org-roam
    :ensure t
    :custom
    (org-roam-directory "~/.local/usr/org-roam/")
